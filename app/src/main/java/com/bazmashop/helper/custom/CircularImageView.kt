...
class CircularImageView : android.support.v7.widget.AppCompatImageView {
    ...
    @JvmOverloads constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(
        context,
        attrs,
        defStyle
    ) {
        ...
        mBackgroundColor = a.getColor(R.styleable.CircularImageView_circle_background, Color.TRANSPARENT)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawCircle((width / 2).toFloat(), (height / 2).toFloat(), mDrawableRadius, mCircleBackground)
