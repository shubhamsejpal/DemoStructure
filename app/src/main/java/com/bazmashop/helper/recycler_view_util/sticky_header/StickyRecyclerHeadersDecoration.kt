package com.clearcommon.helper.recycler_view_util.sticky_header
...
import com.clearcommon.helper.recycler_view_util.sticky_header.caching.HeaderProvider
import com.clearcommon.helper.recycler_view_util.sticky_header.caching.HeaderViewCache
import com.clearcommon.helper.recycler_view_util.sticky_header.calculation.DimensionCalculator
import com.clearcommon.helper.recycler_view_util.sticky_header.rendering.HeaderRenderer
import com.clearcommon.helper.recycler_view_util.sticky_header.util.LinearLayoutOrientationProvider
...
class StickyRecyclerHeadersDecoration private constructor(
    ...
    constructor(adapter: StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder>) : this(
        adapter,
    ...
    constructor(adapter: StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder>, visibilityAdapter: ItemVisibilityAdapter) : this(
        adapter,
        LinearLayoutOrientationProvider(),
        DimensionCalculator(),
        visibilityAdapter
    ...
    private constructor(
        adapter: StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder>, orientationProvider: OrientationProvider,
    ...
    private constructor(
        adapter: StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder>,
