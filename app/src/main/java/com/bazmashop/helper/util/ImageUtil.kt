...
fun ImageView.loadImage(imagePath: String, pb: ProgressBar?) {
    var path = imagePath
    ...
    BaseApp.il.displayImage(path, this, BaseApp.options, object : ImageLoadingListener {
...
fun ImageView.loadImageNoPlaceHolder(imagePath: String, pb: ProgressBar?) {
    var path = imagePath
    ...
    BaseApp.il.displayImage(path, this, BaseApp.noPlaceHolderOptions, object : ImageLoadingListener {
        override fun onLoadingStarted(imageUri: String, view: View) {
            if (pb != null)
                pb.visibility = View.VISIBLE
        }
...
fun Int.getBitmap(context: Context): Bitmap {
    return BitmapFactory.decodeResource(context.getResources(), this);
}
